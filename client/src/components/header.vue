            ...
            <div class="hidden sm:block">
                <form action="https://formbold.com/s/unique_form_id" method="POST">
                    <div class="relative">
                        ...
                        <input type="text" placeholder="" class="w-full bg-transparent pr-4 pl-9 focus:outline-none" />
                    </div>
                </form>
            </div>

            <div class="flex items-center gap-3 2xsm:gap-7">
                <ul class="flex items-center gap-2 2xsm:gap-4"></ul>

                <!-- User Area -->
                <div class="relative">
                    <a class="flex items-center gap-4" href="#">
                        <span class="hidden text-right lg:block">
                            <span class="block text-sm font-medium text-black">SAIGON-SOFTWARE</span>
                            <span class="block text-xs font-medium">CNPM-CN01</span>
                        </span>

                        <span class="h-12 w-12 overflow-hidden">
                            <img src="../images/user/hcmut.png" alt="User" />
                        </span>
                    </a>
                </div>
                <!-- User Area -->
