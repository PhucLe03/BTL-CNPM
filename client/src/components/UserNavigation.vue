<template>
    <aside
        ...
        <!-- SIDEBAR HEADER -->
        <div class="flex h-64 w-64 items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
            <img src="https://www.jollyboxdesign.com/wp-content/uploads/2021/08/Administrator.png" />
        </div>
        <!-- SIDEBAR HEADER -->
